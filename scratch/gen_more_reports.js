...
const files = {
  'pages/GiftsListReport.tsx': `import { useState, useEffect } from 'react';
...
export default function GiftsListReport() {
  ...
  'pages/RoutesListReport.tsx': `import { useState, useEffect } from 'react';
import axios from 'axios';
import { Download } from 'lucide-react';
import * as XLSX from 'xlsx';
...
const imports = `import GiftsListReport from './pages/GiftsListReport';
import RoutesListReport from './pages/RoutesListReport';
`;

appCode = appCode.replace("import GeoFencingListReport from './pages/GeoFencingListReport';", "import GeoFencingListReport from './pages/GeoFencingListReport';\n" + imports);

const listRoutes = `<Route path="gifts" element={<GiftsListReport />} />
            <Route path="routes" element={<RoutesListReport />} />`;

appCode = appCode.replace(`<Route path="geo-fencing" element={<GeoFencingListReport />} />`, `<Route path="geo-fencing" element={<GeoFencingListReport />} />\n            ` + listRoutes);
