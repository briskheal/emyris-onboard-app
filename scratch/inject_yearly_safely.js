...
// 3. Replace the JSX block using precise substring replacement
const startIndex = c.indexOf("{activeSubTab === 'yearly' && (");
const endString = "      )}\n\n    </div>\n  );\n}";
const endIndex = c.indexOf(endString, startIndex);
...
c = c.substring(0, startIndex) + newJsx + c.substring(endIndex);
