...
const start = c.indexOf('function EditDeleteTab() {');
let end = start;
let brackets = 0;
...
const newComponent = `function EditDeleteTab() {
...
fs.writeFileSync('xla-frontend/src/pages/ManageUsers.tsx', before + newComponent + after);
console.log('Successfully replaced EditDeleteTab');
