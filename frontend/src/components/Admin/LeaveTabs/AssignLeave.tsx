                ...
                <form onSubmit={handleAssign} style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.75rem', alignItems: 'flex-start' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                            ...
                            <select className="form-input" style={{ minHeight: '45px', padding: '0.5rem 1rem' }} value={selectedYear} onChange={(e) => setSelectedYear(e.target.value)} required>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem', position: 'relative' }} ref={dropdownRef}>
                        ...
                        <div 
                            ...
                            style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer', minHeight: '45px', padding: '0.5rem 1rem', border: '1px solid var(--glass-border)' }}
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                            ...
                            <select className="form-input" style={{ minHeight: '45px', padding: '0.5rem 1rem' }} value={selectedLeaveTypeId} onChange={(e) => setSelectedLeaveTypeId(e.target.value)} required>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.75rem', alignItems: 'flex-end' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                            ...
                            <input
                                ...
                                step="0.5"
                                className="form-input"
                                style={{ minHeight: '45px', padding: '0.5rem 1rem' }}
                        ...
                        <div>
                            <button type="submit" className="btn btn-primary" style={{ minHeight: '45px', width: '100%' }} disabled={submitting}>
