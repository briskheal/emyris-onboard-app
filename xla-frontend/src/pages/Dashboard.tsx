...
export default function Dashboard() {
  return (
    <div className="min-h-full bg-[#1e1e2d] flex flex-col pb-6">
      {/* Header */}
      <div className="flex items-center justify-between px-5 pt-12 pb-4 sticky top-0 bg-[#1e1e2d] z-10 border-b border-slate-700/50">
