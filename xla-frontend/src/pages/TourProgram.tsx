...
export default function TourProgram() {
  ...
  const days = [
    { date: 1, day: 'SAT', status: 'Allowed', route: 'Hyderabad - Vadodara', badge: 'OUT' },
    { date: 2, day: 'SUN', status: 'Not Allowed' },
    { date: 3, day: 'MON', status: 'Allowed', route: 'Local Working', badge: 'HQ' },
    { date: 4, day: 'TUE', status: 'Allowed', route: 'Vadodara - Rajkot', badge: 'OUT' },
    { date: 5, day: 'WED', status: 'Allowed', route: '', badge: '' }, // Empty day ready to be planned
  ];
