...
import { LayoutDashboard, PlusCircle, Settings as SettingsIcon, Wrench, Menu, Receipt, MonitorPlay, Target, BarChart3, Clock, Bell, ClipboardList, Gift, PieChart, Users, History, CheckSquare, LogOut } from 'lucide-react';
