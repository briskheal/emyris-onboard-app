    ...
    <div className="min-h-full bg-slate-900 flex flex-col relative">
      ...
      <div className="flex items-center gap-3 px-4 pt-4 pb-4 bg-slate-800 border-b border-slate-700/60 sticky top-0 z-10">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-slate-400">Track your daily allowances</p>
        </div>
        {!showNew && (
      ...
      <div className="flex-1 p-4">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="bg-slate-800 rounded-2xl p-4 border border-slate-700/50">
            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">Pending</p>
          ...
          <div className="bg-slate-800 rounded-2xl border border-slate-700 p-4 mb-6 shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-1.5">Amount (₹)</label>
              ...
              <div>
                <label className="block text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-1.5">Remarks (Optional)</label>
        ...
        <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-3 px-1">Expense History</h3>
        ...
        {loading ? (
          ...
          <div className="space-y-3 pb-6">
            {expenses.map(exp => {
              ...
              return (
                <div key={exp._id} className="bg-slate-800 rounded-2xl p-4 border border-slate-700/50 flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          <span className="text-xs text-slate-400">{new Date(exp.date).toLocaleDateString('en-IN', { day: 'numeric', month: 'short' })}</span>
