  ...
  return (
    <div className="min-h-full bg-slate-800 flex flex-col font-sans pb-24 text-white">
      <div className="px-4 py-4 mt-2 flex items-center justify-between">
        <h2 className="text-xl font-bold text-sky-400 mb-6">Effort Analysis Report</h2>
        <button className="w-10 h-10 bg-sky-500 rounded-full text-white flex items-center justify-center shadow-md mb-6">
          <Share2 size={18} />
        </button>
      </div>
            ...
            <button
              ...
              className={`flex-shrink-0 flex flex-col items-center justify-center py-2 px-6 rounded-3xl border transition-all ${
                activeWeek === w.id 
                  ...
                  : 'bg-slate-900 border-slate-200 text-sky-400'
              }`}
            >
      ...
      {!loading && metrics && (
        <div className="px-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-slate-900 rounded-2xl p-4 shadow-sm border border-slate-700/50">
          ...
          {/* Doctor Stats Block */}
          <div className="bg-slate-900 rounded-3xl p-5 shadow-sm border border-slate-700/50 relative overflow-hidden">
            <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-indigo-500 rounded-l-3xl"></div>
            <div className="flex items-center gap-3 mb-4 pl-2">
              <div className="w-8 h-8 rounded-full bg-indigo-500/20 flex items-center justify-center">
                <Users size={16} className="text-indigo-600" />
              </div>
              <h3 className="font-bold text-sky-400">Doctor Metrics</h3>
            </div>
            
            <div className="space-y-3 pl-2">
              <div className="flex justify-between items-center border-b border-slate-700 pb-2">
                <span className="text-sm text-slate-300">Total Doctors List</span>
                <span className="font-bold text-white">{metrics.totalDoctors}</span>
              </div>
              <div className="flex justify-between items-center border-b border-slate-700 pb-2">
                <span className="text-sm text-slate-300">Total Calls Made</span>
                <span className="font-bold text-white">{metrics.totalDrCalls}</span>
              </div>
              <div className="flex justify-between items-center border-b border-slate-700 pb-2">
                <span className="text-sm text-slate-300">Unique Visited</span>
                <span className="font-bold text-sky-600">{metrics.totalUniqueDoctorsVisited}</span>
              </div>
              <div className="flex justify-between items-center border-b border-slate-700 pb-2">
                <span className="text-sm text-slate-300">Missed Doctors</span>
                <span className="font-bold text-rose-500">{metrics.totalMissedDoctors}</span>
              </div>
              <div className="flex justify-between items-center pt-1">
                <span className="text-sm text-slate-300">Call Average / Day</span>
                <span className="font-bold text-white">{metrics.doctorCallAverage}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900 rounded-3xl p-5 shadow-sm border border-slate-700/50 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-4 pl-2">
              ...
              <h3 className="font-bold text-sky-400">List Categorization</h3>
            </div>

            <div className="space-y-3 pl-2">
              <div className="flex justify-between items-center border-b border-slate-700 pb-2">
                <span className="text-sm text-slate-300">Super Core</span>
                <span className="font-bold text-white">{metrics.numSuperCore}</span>
              </div>
              <div className="flex justify-between items-center border-b border-slate-700 pb-2">
                <span className="text-sm text-slate-300">Core</span>
                <span className="font-bold text-white">{metrics.numCore}</span>
              </div>
              <div className="flex justify-between items-center pt-1">
                <span className="text-sm text-slate-300">Non Core</span>
                <span className="font-bold text-white">{metrics.numNonCore}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900 rounded-3xl p-5 shadow-sm border border-slate-700/50 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-4 pl-2">
              ...
              <h3 className="font-bold text-sky-400">Trade Metrics</h3>
            </div>

            <div className="space-y-3 pl-2">
              <div className="flex justify-between items-center border-b border-slate-700 pb-2">
                <span className="text-sm text-slate-300">Total Chemists</span>
                <span className="font-bold text-white">{metrics.totalChemists}</span>
              </div>
              <div className="flex justify-between items-center border-b border-slate-700 pb-2">
                <span className="text-sm text-slate-300">Chemist Calls</span>
                <span className="font-bold text-white">{metrics.totalChemCalls}</span>
              </div>
              <div className="flex justify-between items-center border-b border-slate-700 pb-2">
                <span className="text-sm text-slate-300">Total Stockists</span>
                <span className="font-bold text-white">{metrics.totalStockists}</span>
              </div>
              <div className="flex justify-between items-center pt-1">
                <span className="text-sm text-slate-300">Stockist Calls</span>
                <span className="font-bold text-white">{metrics.totalStockCalls}</span>
              </div>
            </div>
          </div>
